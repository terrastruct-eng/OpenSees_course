...
# Global behaviour
recorder  Node  -file Pushover_Horizontal_ReactionsY.out  -time  -node $N_A0 $N_B0 $N_C0 $N_D0 -dof 2  reaction
recorder  Node  -file Pushover_Storey_DisplacementY.out  -time  -node $N_A1 $N_B1 $N_C1 $N_D1 -dof 2 disp    
...
set phi1 1;
  # pattern PatternType $PatternID TimeSeriesType
    ...
    # load $nodeTag (ndf $LoadValues)
      load    $N_A1    0.0  [expr $mass1*$phi1] 0.0 0.0 0.0 0.0 
      load    $N_B1    0.0  [expr $mass1*$phi1] 0.0 0.0 0.0 0.0 
      load    $N_C1    0.0  [expr $mass1*$phi1] 0.0 0.0 0.0 0.0 
      load    $N_D1    0.0  [expr $mass1*$phi1] 0.0 0.0 0.0 0.0
    };
...
integrator  DisplacementControl $N_A1 2    $step 
# Analysis Type 
analysis  Static 
