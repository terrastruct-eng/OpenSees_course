...
# Global behaviour
recorder  Node  -file TimeHistory_Horizontal_ReactionsY.$k.$j.out  -time  -node $N_A0 $N_B0 $N_C0 $N_D0 -dof 2 reaction
recorder  Node  -file TimeHistory_Storey_DisplacementY.$k.$j.out  -time  -node $N_A1 $N_B1 $N_C1 $N_D1  -dof 2 disp  
recorder  Node  -file TimeHistory_Storey_AccelerationY.$k.$j.out  -time  -node $N_A1 $N_B1 $N_C1 $N_D1  -dof 2 accel    
...
pattern   UniformExcitation 3           2    -accel  $TimeSeries01                                           
# Constraint Handler 
